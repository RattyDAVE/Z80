COLS        EQU     80; 80 
LINES       EQU     25; 25 
SCREENSIZE  EQU     COLS*LINES 

CR          EQU     0DH 
LF          EQU     0AH 
CS          EQU     0CH 

;SER_BUFSIZE EQU     003FH 
;SER_EMPTYSIZE EQU   0005H 
;RTS_HIGH    EQU     00D6h 
;RTS_LOW     EQU     0096h 
;SERBUF      EQU     08000h 
;SERRDPTR    EQU     08041h 
;SERBUFUSED  EQU     08043h 
;WAITFORCHAR EQU     0074h 


include init_debug.z80
                    ;include init.z80
...
ANSI_SCRM:  DB      27,"[27h",00 ; Set screen mode to 80x25
ANSI_CLS:   DB      27,"[2J",00 ;Clear Screen
ANSI_HOME:  DB      27,"[;H",00 ;Put cursor at 0,0
ANSI_RESET: DB      27,"[0m",00 ;Reset all attributes
...
INIT_STR1:  DB      "Initalising Screen",00 
                    ;INIT_STR2:  DB      "Screen Initalised",00
                    ;STRING1:    DB      "Lets start this thing",00

MEM_READWRITE:      ;READ WRITE
LOOP_COUNTER: DB    00 ; Used for Debugging
                    ;SCR_LINES:  DB      LINES Now a constant
                    ;SCR_COLS:   DB      COLS Now a constant
SCR_BUFF:   DS      SCREENSIZE ; Screen Buffer. (Characters)
SCR_ATTR:   DS      SCREENSIZE ; Screen Attributes. (Colours)
                    ;TEST_END:   DB      255
SCR_ATTR_BUFF: DS   01 ; Screen Attrib buffer.
